                ...
                <article class="content items-list-page">
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> {{ $title }} <a href="{{ route('customer.create')}}" class="btn btn-primary btn-sm rounded-s"> Add New </a>
                                        <div class="action dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <a class="dropdown-item" href="{{ route('customer.export') }}"><i class="fa fa-file-export icon"></i> Export</a>
                                                <a class="dropdown-item" href="{{ route('customer.import') }}"><i class="fa fa-file-import icon"></i> Import</a>
                                            </div>
                                        </div>
                                    </h3>
