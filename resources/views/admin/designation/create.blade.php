                    ...
                    <div class="col-sm-5">
                        <form action="{{ route('dashboard.designation.store') }}" method="POST">
                            ...
                            <div class="form-group float-label-control">
                                ...
                                <input type="text" name="short_form" class="form-control" placeholder="Title" required>
                                <small id="emailHelp" class="form-text text-muted"></small>
                            </div>
                            ...
                            <div class="form-group float-label-control">
                                <button class="btn btn-primary btn-block" type="submit">Create designation</button>
                            </div>
                        </form>
                    </div>
                    <div class="clearfix"></div>
