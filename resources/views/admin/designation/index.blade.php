            ...
            <div class="row">
                ...
                <div class="col-sm-3" style="padding-left: 0">
                    <div class="sidebar-right"
                        ...
                        <h4 class="sidebar-title"><i class="fa fa-plus"></i> Add new designation</h4>
                        <hr>

                        <form id="createPackage" method="post" action="{{ route('dashboard.designation.store') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="">Title (Short)</label>
                                <input type="text" name="short_form" placeholder="Title" class="form-control" required>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        var url = "{{ route('dashboard.designation.index') }}";
        //
        ...
        $.fn.dataTable.pipeline = function (opts) {
            ...
            var conf = $.extend({
                ...
                url: "{{ route('dashboard.designation.index') }}",      // script url
                ...
                "columns": [
                    ...
                    {"data": "department.name"},
                    {
                        "mRender": function (data, type, row) {
                            let str = "<a href='/dashboard/designation/edit/" + row['id'] + "' class='btn btn-secondary btn-xs'><i class='fa fa-edit'></i></a>";
                            return str;
                        }
                    }
                ],
