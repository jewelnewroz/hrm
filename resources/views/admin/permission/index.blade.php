                ...
                <article class="content items-list-page">
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> {{ $title }} <a href="{{ route('permissions.create')}}" class="btn btn-primary btn-sm rounded-s"> Add New </a>
                                        <div class="action dropdown">
                                            <button class="btn  btn-sm rounded-s btn-secondary dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-cog"></i></button>
                                ...
                                @foreach( $lists as $list )
                                  <p class="card-text">
                                      <span class="label-text">{{ $list->name }}
                                        <a href="{{ route('permissions.edit', $list->id)}}"><i class="fa fa-edit"></i></a>
                                      </span>
                                  </p>
                                @endforeach
                              </div>
